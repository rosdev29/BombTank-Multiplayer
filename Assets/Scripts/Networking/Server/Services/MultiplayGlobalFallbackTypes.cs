...
// Global fallback types for stale/cached source variants that reference Multiplay
// symbols without namespace qualification.
...
public sealed class MultiplayService : IMultiplayService
{
    ...
    {
        return Task.FromResult<IServerQueryHandler>(new NullServerQueryHandler
        {
